...
#Plots of significant binary (0/1) variables:
  ...
  #hs_diploma_or_equiv
ggplot(data = prob_auto_final) + geom_boxplot(aes(x = as.factor(hs_diploma_or_equiv), y = p_automation,color=)) +
  ...
  #is_medical
ggplot(data = prob_auto_final) + geom_boxplot(aes(x = as.factor(is_medical), y = p_automation,color=)) +
...
ggplot(prob_auto_final, aes(x = complexity, y = p_automation)) +
  ...
  scale_y_continuous(limits = c(0, 1)) +
  theme_minimal(base_size = 12)
    #this shows the decrease in probability of autimation as task complexity increases


#Plots of other binary (0/1) variables still in model:
  #no_ed_requirement
ggplot(data = prob_auto_final) + geom_boxplot(aes(x = as.factor(no_ed_requirement), y = p_automation,color=)) +
  ...
  #doctoral               
ggplot(data = prob_auto_final) + geom_boxplot(aes(x = as.factor(doctoral), y = p_automation,color=)) +
  ...
  #is_programming                         
ggplot(data = prob_auto_final) + geom_boxplot(aes(x = as.factor(is_programming), y = p_automation,color=)) +
  labs(x = "No Education Requirement", y = "Probability of Automation")
    #this shows the increased p_automation when the occupation involved computer programming
  #is_blue_collar                                   
ggplot(data = prob_auto_final) + geom_boxplot(aes(x = as.factor(is_blue_collar), y = p_automation,color=)) +
  labs(x = "No Education Requirement", y = "Probability of Automation")
    #this shows the increased p_automation when the occupation is blue collar
  #is_service                                      
ggplot(data = prob_auto_final) + geom_boxplot(aes(x = as.factor(is_service), y = p_automation,color=)) +
  labs(x = "No Education Requirement", y = "Probability of Automation")
